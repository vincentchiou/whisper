...
description: 壓縮這個 Whisper 字幕專案第二版的續接資訊與操作重點。當需要快速接手此專案、確認 YouTube 輸入、TXT/SEO 輸出、字幕術語校正、長影音分段轉錄，或避免再次誤判成抽獎系統時使用。
---
